    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="asset/img/logo.webp" alt="Logo Amarta" style="height: 80px;">
            </a>
            ...
            <div class="footer-content">
                ...
                <div class="footer-column footer-logo-section">
                    <div class="logo-container">
                        <img img src="asset/img/logo.webp" alt="">
                    </div>
                ...
                <div class="footer-column">
                    ...
                    <a href="https://maps.app.goo.gl/N4aaiUqooULfei4P6" class="location-btn">
                ...
                <div class="footer-column contact-section">
                    ...
                    <p class="consultation-text">{{ __('app.consultation_text') }}</p>
                     ...
                     <div class="social-links">
                        ...
                        <a href="https://www.instagram.com/lpkamartacibitung?igsh=MTdzNGhocHlxbTlyaA==" class="social-link instagram">
                            <svg class="social-icon" viewBox="0 0 24 24">
                        ...
                        <a href="mailto:lpkamartacibitung@gmail.com" class="social-link email">
                            <svg class="social-icon" viewBox="0 0 24 24">
                        ...
                        <a href="#" class="social-link tiktok">
                            <svg class="social-icon" viewBox="0 0 24 24">
                                <path d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 0 1-2.909 2.909 2.896 2.896 0 0 1-2.909-2.909 2.896 2.896 0 0 1 2.909-2.909c.301 0 .583.056.849.142V9.379a6.459 6.459 0 0 0-.849-.059A6.391 6.391 0 0 0 3.077 15.7a6.391 6.391 0 0 0 6.388 6.388A6.391 6.391 0 0 0 15.853 15.7v-4.319a8.69 8.69 0 0 0 4.512 1.259v-3.532a4.808 4.808 0 0 1-.776-.422z"/>
                            </svg>
                        </a>
                    </div>
                </div>
