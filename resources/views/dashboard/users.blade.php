                                    ...
                                    <div class="card-body">
                                        ...
                                        @if($pendingBooking)
                                            @if($pendingBooking->status === 'Pending')
                                                ...
                                                <a href="{{ route('transaksi.booking', ['id' => $pendingBooking->id]) }}" class="btn btn-warning">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if(isset($announcement) && !empty($announcement->meet_link))
                                            <p class="text-muted mb-3">
                                                Pembayaran booking Anda sudah berhasil. Silakan bergabung dengan meeting kelas sesuai jadwal yang ditentukan.
                                            </p>
...
<style>
    ...
    .announcement-card.priority-high .priority-bar {
        background: linear-gradient(90deg, var(--danger), #dc2626);
    }

    .announcement-card.priority-medium .priority-bar {
        background: linear-gradient(90deg, var(--warning), #d97706);
    }

    .announcement-card.priority-low .priority-bar {
    ...
    .announcement-card.priority-medium .announcement-icon {
        background: #fef3c7;
        color: var(--warning);
    }

    .announcement-card.priority-low .announcement-icon {
        background: #dbeafe;
        color: var(--info);
    }
